...
This repository contains files relating to our final project for CSC 381 (Recommender Systems) at Davidson College. The repository is divided into three folders: Folder 1, Folder 2, and Folder 3. Folder 1 contains the LaTeX tex file and the files required to generate the PDF document. Folder 2 contains all python files and results, in addition to this README.txt file. Folder 3 contains the data used to train these models.
...
Results are saved inside Folder 2, but the location depends on the command. NCF model results are saved to Folder 2/ncf_models. LOOCV results are saved to the final_result_full.csv file. Our past results have been renamed and stored in individual folders, for example, Folder 2/results_hybrid. 
